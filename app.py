...
app = Flask(__name__)
model = pickle.load(open(r'D:\Ms Repeatedly\VSCode\Customer-Survival-Analysis-and-Churn-Prediction-master\model.pkl', 'rb'))
survmodel = pickle.load(open(r'D:\Ms Repeatedly\VSCode\Customer-Survival-Analysis-and-Churn-Prediction-master\survivemodel.pkl', 'rb'))
